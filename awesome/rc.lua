...
tags = {
    names = {"main", "www", 3, 4, 5, 6, 7, "email", "music"}
...
globalkeys = awful.util.table.join(
    ...
    -- Volume controls
    awful.key({"Control", "v"}, ".", function () awful.util.spawn("amixer set Master 5%+") end),
    awful.key({"Control", "v"}, ",", function () awful.util.spawn("amixer set Master 5%-") end),
    awful.key({"Control", "v"}, "/", function () awful.util.spawn("amixer set Master toggle") end),
